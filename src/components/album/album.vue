  ...
  <div id='album'>
    <div v-if="NO_FOUND">
      ...
      <div class="songlist_top" ref='songlisttop' v-if='album != null'>
        <div class="back_" v-if='album.mid != undefined'
             :style='"background:url(https://y.gtimg.cn/music/photo_new/T002R150x150M000"+album.mid+".jpg?max_age=2592000) center"'></div>
        <div class="back_content">
          <div class="tx_title_ clear">
            <img class="tx_ left" v-if='album.mid != undefined'
                 :src='"https://y.gtimg.cn/music/photo_new/T002R150x150M000"+album.mid+".jpg?max_age=2592000"' alt="">
            <div class="right_ left">
              <h2 class="title_">{{album.name}}</h2>
              <p class="clear url_name_con"><img class="min_tx left" v-if='album.singermid != undefined'
                                                 :src="'https://y.gtimg.cn/music/photo_new/T001R150x150M000'+album.singermid+'.jpg?max_age=2592000'"><span
                class="person_name left">{{album.singername}}</span></p>
              <p class="clear">
      ...
      <div class="songlist_content bscroll" ref='bscroll'>
        ...
        <ul class="song_list">
          <h2 class="songlist_title clear">
            ...
            <span class="songlist_title_right right" @click='favorites'>收藏<i
              class="iconfont icon_fa">&#xe60c;</i></span>
          </h2>
          <div class="gedan_list">
            <li v-for='(list,index) of album.list' :key='index' class="song_list_item"
                :class="list.alertid == 0?'ccc':''"
                @click='clickPlay(list.songmid,list.alertid == 0,list.songname,list.songid)'>
          ...
          <div class="rohlinqui_tit" v-if='album.desc && album.desc !=""'>
            <h1 class="rohlinqui_tit__text">歌单简介</h1>
          </div>
          <div v-if='album.desc && album.desc !=""'>
            <p class="jianjie_p" v-html='album.desc'></p>
          </div>
          <div class="rohlin_zuixin_zhuanji">
            <div class="zuixin_zhuanji">
              <h1 class="rohlinqui_tit__text">该歌手的其他专辑</h1>
            </div>
            <ul class="zhuanji_ul">
              <li v-for='albumlist of album.otherAlbums' :key='albumlist.albumMid'
                  @click="gotoablum(albumlist.albumid)">
                <div class="zj_div">
                  <img class="zhuanji_img"
                       :src="'https://y.gtimg.cn/music/photo_new/T002R150x150M000'+albumlist.albumMid+'.jpg?max_age=2592000'"
                       alt="">
              ...
              <li v-for='(commentitem,index) of comment.commentlist' :key='index'>
                <div class="mt_top">
                  ...
                  <div class="mt_top_left">
                    <h4><span>{{commentitem.nick}}</span><img v-if='commentitem.vipicon != ""' class="vipicon_icon"
                                                              :src="commentitem.vipicon" alt=""></h4>
