<template>
  <div id='toplist'>
    ...
    <div class="songlist_top" ref='songlisttop' v-if='data != {}'>
      <div class="back_" v-if='data.topinfo && data.topinfo.pic_album != ""'
           :style='"background:url("+data.topinfo.pic_album+") center"'>
    ...
    <div class="songlist_content bscroll" ref='bscroll'>
      ...
      <ul class="song_list">
        ...
        <div class="gedan_list">
          ...
          <li v-for='(songlistItem,index) of data.songlist' :key='index' class="song_list_item"
              @click='clickPlay(songlistItem.data.songmid,false,songlistItem.data.songname,songlistItem.data.songid)'>
            ...
            <div class="song_name_dec">
              ...
              <p class='song_dec'>
                ...
                <span v-for='(item,index) of songlistItem.data.singer' :key='item.id'>{{item.name}}</span><span
                v-if='songlistItem.data.albumdesc && songlistItem.data.albumdesc !=""'>·</span><span>{{songlistItem.data.albumdesc}}</span>
              </p>
            </div>
          </li>
        </div>
        <div class="rohlinqui_tit">
          <h1 class="rohlinqui_tit__text">简介</h1>
        </div>
